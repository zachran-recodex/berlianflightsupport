            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-semibold">List of Blogs</h3>
                        ...
                        <tbody>
                            @forelse ($blogs as $blog)
                                <tr>
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">{{ $blog->author }}</td>
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">
                                        <span class="{{ $blog->status ? 'text-green-500' : 'text-red-500' }}">
                                    ...
                                    <td class="border border-gray-300 px-4 py-2">
                                        <div class="flex gap-2">
                                            ...
                                            <form action="{{ route('admin.blogs.destroy', $blog->slug) }}"
                                                method="POST"
