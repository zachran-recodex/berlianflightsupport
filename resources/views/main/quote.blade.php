@section('meta_tag')
    ...
    <meta name="description" content="{{ $pageSetups['quote']->meta_description }}">
    <meta name="keywords" content="{{ $pageSetups['quote']->meta_keywords }}">
    ...
    <title>{{ $pageSetups['quote']->meta_title }}</title>
@endsection
