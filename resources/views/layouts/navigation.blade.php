<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.abouts.index')" :active="request()->routeIs('admin.abouts.index')">
                {{ __('About') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('admin.heroSections.index')" :active="request()->routeIs('admin.heroSections.index')">
                {{ __('Hero Section') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.pageSetups.index')" :active="request()->routeIs('admin.pageSetups.index')">
                {{ __('Page Setup') }}
            </x-responsive-nav-link>
